...
## Fait
- [x] Structure de continuité, 33 décisions actées (D-001 à D-033)
...
- **On peut vérifier un son sans l'entendre.** En espionnant les oscillateurs créés par le moteur audio et en convertissant leurs fréquences en noms de notes, on lit la mélodie jouée et son rythme. C'est la seule preuve possible quand on ne peut pas écouter la page.
